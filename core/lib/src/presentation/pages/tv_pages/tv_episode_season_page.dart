...
import 'package:core/src/presentation/cubit/tv/tv_series_episode_season_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SizedBox.expand(
        child:
            BlocBuilder<TVSeriesEpisodeSeasonCubit, TVSeriesEpisodeSeasonState>(
            ...
            if (state is TVSeriesEpisodeSeasonLoadingState) {
              ...
              if (state.items.isEmpty) {
                return Padding(
                  ...
                  child: Center(
                    child: Text(
                        'Episode untuk ${tv.name} ${season.name} tidak ditemukan'),
                  ),
                );
              }
                    ...
                    trailing: InkWell(
                      ...
                      onTap: () async {
                        await showModalBottomSheet(
                          ...
                          context: context,
                          builder: (context) =>
                              _ModalDetailCrewAndGuestStar(episode: episode),
                        );
                      },
