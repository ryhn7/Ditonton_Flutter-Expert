...
import 'package:core/src/data/repositories/tv_repository_impl.dart';
...
void main() {
  ...
  final tvModelList = jsonListSearchTV
  ...
  final tvDetailRespon = TVDetailResponse.fromJson(
  ...
  group('Airing Today TV Series', () {
    test(
      ...
      () async {
        /// arrange
        when(mockTVRemoteDataSource.getAiringTodayTVSeries())
  ...
  group('Detail TV Series', () {
    test(
      ...
      () async {
        /// arrange
        when(mockTVRemoteDataSource.getDetailTVSeries(id))
            .thenAnswer((_) async => tvDetailRespon);
  ...
  group('Search TV Series', () {
    test(
      ...
      () async {
        /// arrange
        when(mockTVRemoteDataSource.searchTVSeries(query))
            .thenAnswer((_) async => tvModelList);
  ...
  group('Episode of season TV Series', () {
    test(
      ...
      () async {
        /// arrange
        when(mockTVRemoteDataSource.getEpisodeSeasonTVSeries(
                id: id, seasonNumber: seasonNumber))
            .thenAnswer((_) async => tvEpisodeSeasonList);

        /// act
        final result = await repository.getEpisodeSeasonTVSeries(
            id: id, seasonNumber: seasonNumber);

        /// assert
        verify(mockTVRemoteDataSource.getEpisodeSeasonTVSeries(
            id: id, seasonNumber: seasonNumber));
  ...
  group('Watchlist TV Series', () {
    test('should return list of TV Series', () async {
      ///arrange
      when(mockTVLocalDataSource.getWatchlist())
  ...
  group('save tv series', () {
    ...
    test(
      ...
      final result = await repository.insertWatchlistTVSeries(testTVDetail);
      // assert
      verify(mockTVLocalDataSource.insertWatchlist(testTVSeriesTable));
      expect(result, equals(Left(ServerFailure(''))));
    });
  ...
  group('get watchlist status', () {
    test('should return watch status whether data is found', () async {
      // arrange
      const tId = 1;
      when(mockTVLocalDataSource.getDataById(tId))
