...
import 'package:core/src/data/models/tv/tv_detail/tv_detail_model.dart';
...
void main() {
  ...
  group(
    ...
    () {
      final list = (jsonDecode(readJson('dummy_data/tv_airing_today.json'))['results']) as List;
      final listTVSeries =
          list.map((e) => TVModel.fromJson(Map<String, dynamic>.from(e as Map))).toList();
      test(
        ...
        () async {
          ...
          when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/airing_today?$API_KEY'))).thenAnswer(
            (_) async => http.Response(readJson('dummy_data/tv_airing_today.json'), 200, headers: {
  ...
  group('get popular tv series', () {
    final list = (jsonDecode(readJson('dummy_data/tv_popular.json'))['results']) as List;
    final listTVSeries =
        list.map((e) => TVModel.fromJson(Map<String, dynamic>.from(e as Map))).toList();
    ...
    test(
      ...
      () async {
        ...
        when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/popular?$API_KEY'))).thenAnswer(
          (_) async => http.Response(readJson('dummy_data/tv_popular.json'), 200, headers: {
            /// Use this header when you get error Invalid String contain when decode json ...
            /// Reference to this [https://stackoverflow.com/questions/52990816/dart-json-encodedata-can-not-accept-other-language/52993623#52993623]
            HttpHeaders.contentTypeHeader: 'application/json; charset=utf-8',
          }),
  ...
  group('get top rated tv series', () {
    final list = (jsonDecode(readJson('dummy_data/tv_top_rated.json'))['results']) as List;
    final listTVSeries =
        list.map((e) => TVModel.fromJson(Map<String, dynamic>.from(e as Map))).toList();
    test(
      ...
      () async {
        ...
        when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/top_rated?$API_KEY'))).thenAnswer(
          (_) async => http.Response(readJson('dummy_data/tv_top_rated.json'), 200, headers: {
            /// Use this header when you get error Invalid String contain when decode json ...
            /// Reference to this [https://stackoverflow.com/questions/52990816/dart-json-encodedata-can-not-accept-other-language/52993623#52993623]
            HttpHeaders.contentTypeHeader: 'application/json; charset=utf-8',
          }),
  ...
  group('search TV Series', () {
    final list = (jsonDecode(readJson('dummy_data/tv_search.json'))['results']) as List;
    final listTVSeries =
        list.map((e) => TVModel.fromJson(Map<String, dynamic>.from(e as Map))).toList();
    ...
    test(
      ...
      () async {
        ...
        when(mockHttpClient.get(Uri.parse('$BASE_URL/search/tv?$API_KEY&query=$query'))).thenAnswer(
          (_) async => http.Response(readJson('dummy_data/tv_search.json'), 200, headers: {
            /// Use this header when you get error Invalid String contain when decode json ...
            /// Reference to this [https://stackoverflow.com/questions/52990816/dart-json-encodedata-can-not-accept-other-language/52993623#52993623]
            HttpHeaders.contentTypeHeader: 'application/json; charset=utf-8',
          }),
  ...
  group('get recommendation TV Series', () {
    final list = (jsonDecode(readJson('dummy_data/tv_recommendation.json'))['results']) as List;
    final listTVSeries =
        list.map((e) => TVModel.fromJson(Map<String, dynamic>.from(e as Map))).toList();
    ...
    test(
      ...
      () async {
        ...
        when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/$id/recommendations?$API_KEY'))).thenAnswer(
          (_) async => http.Response(readJson('dummy_data/tv_recommendation.json'), 200, headers: {
            /// Use this header when you get error Invalid String contain when decode json ...
            /// Reference to this [https://stackoverflow.com/questions/52990816/dart-json-encodedata-can-not-accept-other-language/52993623#52993623]
            HttpHeaders.contentTypeHeader: 'application/json; charset=utf-8',
          }),
  ...
  group('get episode of season TV Series', () {
    ...
    final list = (jsonDecode(readJson('dummy_data/tv_episode_season.json'))['episodes']) as List;
    final listEpisodeSeasonTVSeries =
        list.map((e) => EpisodeModel.fromJson(Map<String, dynamic>.from(e as Map))).toList();
    ...
    test(
      ...
      () async {
        ...
        when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/$id/season/$seasonNumber?$API_KEY')))
            .thenAnswer(
          (_) async => http.Response(readJson('dummy_data/tv_episode_season.json'), 200, headers: {
            /// Use this header when you get error Invalid String contain when decode json ...
            /// Reference to this [https://stackoverflow.com/questions/52990816/dart-json-encodedata-can-not-accept-other-language/52993623#52993623]
            HttpHeaders.contentTypeHeader: 'application/json; charset=utf-8',
          }),
    ...
    test(
      ...
      () async {
        ...
        /// act
        final call = dataSource.getEpisodeSeasonTVSeries(id: id, seasonNumber: seasonNumber);
    ...
    test(
      ...
      () async {
        ...
        when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/$id?$API_KEY'))).thenAnswer(
          (_) async => http.Response(readJson('dummy_data/tv_detail.json'), 200, headers: {
            /// Use this header when you get error Invalid String contain when decode json ...
            /// Reference to this [https://stackoverflow.com/questions/52990816/dart-json-encodedata-can-not-accept-other-language/52993623#52993623]
            HttpHeaders.contentTypeHeader: 'application/json; charset=utf-8',
          }),
