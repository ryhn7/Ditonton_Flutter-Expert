...
import 'package:search/presentation/cubit/movie/movie_search_cubit.dart';
import 'package:search/presentation/cubit/tv/tv_series_search_cubit.dart';
              ...
              if (_searchController.text.isNotEmpty) {
                if (value!.category == CategoryMenu.Movie) {
                  ...
                  await context
                      ...
                      .get(_searchController.text);
                } else {
                  /// Call Function TV Series
                  await context
                      .read<TVSeriesSearchCubit>()
                      .get(_searchController.text);
                }
              }
